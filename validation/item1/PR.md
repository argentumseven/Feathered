...
Remote status: no PR has been opened or merged. An authenticated push preflight
failed with GitHub credentials unavailable (could not read Username; terminal
prompts disabled). Branch publication requires an authenticated GitHub session.
